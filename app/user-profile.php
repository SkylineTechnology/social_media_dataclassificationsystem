...
$rows = mysqli_fetch_array(mysqli_query($conn, "select * from members where email='$profile_id'"));
                            ...
                            <div class="col-12 col-lg-5 col-xl-4">
                                ...
                                <div class="box box-inverse bg-img" style="background-image: url(../images/gallery/full/1.jpg);" data-overlay="2">
                                    ...
                                    <div class="box-body text-center pb-50">
                                        ...
                                        <span><i class="fa fa-map-marker w-20"></i> <?php echo $nationality; ?></span>
                                    </div>

                                    <ul class="box-body flexbox flex-justified text-center" data-overlay="4">
                                        <?php
                                        $num_of_my_post = mysqli_num_rows(mysqli_query($conn, "select * from timeline where username='$profile_id'"));
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div>
                                                    ...
                                                    <p>Nationality :<span class="text-gray pl-10"><?php echo $nationality; ?></span></p>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="active tab-pane" id="usertimeline">
                                            ...
                                            <div class="row col-md-12">
                                                ...
                                                $get_post = mysqli_query($conn, "select * from timeline order by date desc limit $current_page_first_item,$item_per_page");
